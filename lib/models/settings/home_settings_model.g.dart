...
_HomeSettingsModel _$HomeSettingsModelFromJson(Map<String, dynamic> json) => _HomeSettingsModel(
      ...
      homeBanner: $enumDecodeNullable(_$HomeBannerEnumMap, json['homeBanner']) ?? HomeBanner.banner,
      carouselSettings: $enumDecodeNullable(_$HomeCarouselSettingsEnumMap, json['carouselSettings']) ??
          HomeCarouselSettings.recommendations,
